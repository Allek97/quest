        ...
        if (visitedCount === 0) {
            ...
            for (const [core, neighboursOfCore] of adjacencyListMaze) {
                if (vertexList.has(core)) {
                    ...
                    if (
                        westNeighbour !== undefined &&
                        !vertexList.has(westNeighbour)
                    ) {
                        ...
                        visitedMazeCells.set(westNeighbour, [
                            "Hunted",
                            westNeighbour.row,
                        ]);
                        break;
                        ...
                        let lastHuntedRow = Math.floor(
                            nodeIdx / columnSizeMaze
                        );
                        ...
                        visitedMazeCells.set(eastNeighbour, [
                            "Hunted",
                            eastNeighbour.row,
                        ]);
                        break;
