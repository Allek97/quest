  ...
  nodes.map((node, nodeIdx) => {
    ...
    if (node.isStart || node.isEnd || !node.isWall) {
      if (!withDiagonals) {
        ...
        if (north !== undefined) {
          if (north[0] === false || north[2] === true || north[3] === true) {
            voisins.push(north[1]);
          }
        }
        if (south !== undefined) {
          if (south[0] === false || south[2] === true || south[3] === true) {
            voisins.push(south[1]);
          }
        }
        if (west !== undefined) {
          if (west[0] === false || west[2] === true || west[3] === true) {
            voisins.push(west[1]);
          }
        }
        if (east !== undefined) {
          if (east[0] === false || east[2] === true || east[3] === true) {
            voisins.push(east[1]);
          }
        }
